...
#SRCS = XiaoHG.c XiaoHG_conf.c
SRCS = $(wildcard *.cxx)

#OBJS = XiaoHG.o XiaoHG_conf.o  这么一个一个增加.o太麻烦，下行换一种写法：把字符串中的.c替换为.o
OBJS = $(SRCS:.cxx=.o)

#把字符串中的.c替换为.d
#DEPS = XiaoHG.d XiaoHG_conf.d
DEPS = $(SRCS:.cxx=.d)

#可以指定BIN文件的位置,addprefix是增加前缀函数
#BIN = /mnt/hgfs/linux/XiaoHG
...
#处理后形如 /mnt/hgfs/linux/XiaoHG/app/link_obj/XiaoHG_signal2.o /mnt/hgfs/linux/XiaoHG/app/link_obj/XiaoHG_signal.o
# := 在解析阶段直接赋值常量字符串【立即展开】，而 = 在运行阶段，实际使用变量时再进行求值【延迟展开】
# /mnt/hgfs/linux/XiaoHG/app/link_obj/XiaoHG.o   /mnt/hgfs/linux/XiaoHG/app/link_obj/XiaoHG_conf.o 
...
#这里是诸多.d文件被包含进来，每个.d文件里都记录着一个.o文件所依赖哪些.c和.h文件。内容诸如 XiaoHG.o: XiaoHG.c XiaoHG_Func.h
...
#.d文件中的内容可能形如：XiaoHG.o: XiaoHG.c XiaoHG_Func.h
#%.d:%.c
$(DEP_DIR)/%.d:%.cxx
#gcc -MM $^ > $@
#.d文件中的内容形如：XiaoHG.o: XiaoHG.c XiaoHG_Func.h ../signal/XiaoHG_signal.h，但现在的问题是我们的.o文件已经放到了专门的目录
...
#上行处理后，.d文件中内容应该就如：/mnt/hgfs/linux/XiaoHG/app/link_obj/XiaoHG.o: XiaoHG.c XiaoHG_Func.h ../signal/XiaoHG_signal.h
